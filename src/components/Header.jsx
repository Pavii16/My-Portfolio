      ...
      <div className="max-w-[90%] mx-auto py-3 flex items-center justify-between font-inter">
        ...
        <div className="lg:hidden">
          <button
            ...
            className=" transition-all duration-500 ease-in text-[#6ea655] "
          >
        ...
        >
          <ul className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-5 text-[14px] font-semibold">
           ...
           <li className="hover:text-[#6ea655] cursor-pointer transition-transform duration-300 ease-in transform hover:translate-y-[-7px] ">
              Home
            </li></Link>
