    ...
    <div id="contact" className="bg-[#ffffff] min-h-screen flex items-center justify-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-[#6ea655]">
            Get in touch
          </h2>
        </div>
        <div className="flex flex-col items-center md:flex-row gap-[150px] justify-center">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#6ea655] text-white py-3 rounded-md font-semibold hover:bg-[#d44810] disabled:opacity-50"
